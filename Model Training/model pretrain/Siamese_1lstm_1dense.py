...
功能：该文件是 1个LSTM层+1个dense层 的主结构文件
并用于训练IPN数据集，产生预训练模型
...
path = 'D:/CNNbkuniversity/compare_model/1LSTM_1DENSE/1lstm_1dense.h5'
...
#训练模型
final.fit([x1,x2] , train_data_y , batch_size=128 , verbose=1,epochs=200)
final.summary()
