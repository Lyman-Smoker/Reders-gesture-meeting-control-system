...
A12 文件，该文件是 1个LSTM层+3个dense层 的主结构文件
并用于训练IPN数据集，产生预训练模型
'''
...
#训练模型
final.fit([x1,x2] , train_data_y , batch_size=128 , verbose=1,epochs=300)
final.summary()


#保存预训练出的神经网络模型
path = 'D:/CNNbkuniversity/compare_model/1LSTM_3DENSE/1lstm_3dense.h5'
final.save(path)
