...
A12 文件，
功能：用 1LSTM+1FULLY_CONNECTION 的已预训练模型结合参数调优图表用来训练 单手动作 数据集最终模型
...
transfer_model_path = 'D:/CNNbkuniversity/compare_model/1LSTM_1DENSE/add_diy_dataset_model/1_hand/1hand_1lstm_1dense.h5'
...
#模型提取
model_1_1_1hand = get_model(pretrain_model_path)
...
model_1_1_1hand.fit( [x1,x2] , train_data_y , batch_size=32 , verbose=2,epochs=200)


model_1_1_1hand.save(transfer_model_path)
