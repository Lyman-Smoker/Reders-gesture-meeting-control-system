...
A12 文件，用包含 1个lstm+2个dense 的已预训练模型用来训练 单手动作 数据集最终模型
...
#模型提取
model_1_2_1hand = get_model('D:/CNNbkuniversity/compare_model/1LSTM_2DENSE/1lstm_2dense.h5')
...
model_1_2_1hand.fit( [x1,x2] , train_data_y , batch_size=32 , verbose=2,epochs=350)


model_1_2_1hand.save('D:/CNNbkuniversity/compare_model/1LSTM_2DENSE/add_diy_dataset_model/1_hand/1hand_1lstm_2dense.h5')
