...
A12 文件，用包含 1个lstm+3个dense 的已预训练模型用来训练 双手动作 数据集最终模型
...
#模型提取
model_1_3_2hand = get_model('D:/CNNbkuniversity/compare_model/1LSTM_3DENSE/1lstm_3dense.h5')
...
model_1_3_2hand.fit( [x1,x2] , train_data_y , batch_size=32 , verbose=2,epochs=100)



model_1_3_2hand.save('D:/CNNbkuniversity/compare_model/1LSTM_3DENSE/add_diy_dataset_model/2_hand/2hand_1lstm_3dense.h5')
