...
A12 文件，用包含 2个lstm+1个dense 的已预训练模型用来训练 单手动作 数据集最终模型
...
#模型提取
model_2_1_1hand = get_model('D:/CNNbkuniversity/compare_model/2LSTM_1DENSE/2lstm_1dense.h5')
...
model_2_1_1hand.fit( [x1,x2] , train_data_y , batch_size=32 , verbose=2,epochs=280)


model_2_1_1hand.save('D:/CNNbkuniversity/compare_model/2LSTM_1DENSE/add_diy_dataset_model/1_hand/1hand_2lstm_1dense.h5')
