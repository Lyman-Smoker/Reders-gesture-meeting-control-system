...
A12 文件，用包含 2个lstm+2个dense 的已预训练模型用来训练 双手动作 数据集最终模型
...
#模型提取
# model_2_2_2hand = get_model('D:/CNNbkuniversity/compare_model/2LSTM_2DENSE/2lstm_2dense.h5')
model_2_2_2hand = get_model('D:/CNNbkuniversity/compare_model/2LSTM_2DENSE/add_diy_dataset_model/2_hand/2hand_2lstm_2dense.h5')
...
model_2_2_2hand.fit( [x1,x2] , train_data_y , batch_size=16 , verbose=2,epochs=300)


model_2_2_2hand.save('D:/CNNbkuniversity/compare_model/2LSTM_2DENSE/add_diy_dataset_model/2_hand/2hand_2lstm_2dense.h5')
