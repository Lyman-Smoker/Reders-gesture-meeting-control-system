...
A12 文件，用包含 2个lstm+3个dense 的已预训练模型用来训练 单手动作 数据集最终模型
...
#模型提取
model_2_3_1hand = get_model('D:/CNNbkuniversity/compare_model/2LSTM_3DENSE/2lstm_3dense.h5')
# model_2_3_1hand = get_model('D:/CNNbkuniversity/compare_model/2LSTM_3DENSE/add_diy_dataset_model/1_hand/1hand_2lstm_3dense.h5')
...
model_2_3_1hand.fit( [x1,x2] , train_data_y , batch_size=32 , verbose=2,epochs=60)


model_2_3_1hand.save('D:/CNNbkuniversity/compare_model/2LSTM_3DENSE/add_diy_dataset_model/1_hand/1hand_2lstm_3dense.h5')
